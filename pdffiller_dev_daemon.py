...
DEBUG = False # Program in debug mode doesn't call   

LOG_FILENAME = '/home/developer/sandbox/pdf_corrected.log' # Filename of log-file if log is written into file.
...
AJAX_CS_STRING = "php /var/www/html/calipso/ajax/cs.php %s" # AJAX running command

if DEBUG:
    STACK_DIR_PATH = "/home/developer/sandbox/stack/"
else:
    STACK_DIR_PATH = "/var/pdffiller/dev_stack/" # Path to stack directory

PID_FILE_PATH = '/tmp/dev_daemon.pid' # full filename of daemon pid file
