...
PID_FILE_PATH = '/var/www/converter/test_daemon.pid' # full filename of daemon pid file
...
class StackListener(FileSystemEventHandler):
    """
    ...
    def process(self, event):
        ...
        self.callback(self, event.src_path, event)
    ...
    def init(self):
        ...
        self.observer.schedule(self, '/mnt/www/dev18/converter/tmp/', recursive=False)
        self.observer.start()
