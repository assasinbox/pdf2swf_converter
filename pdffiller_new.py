...
LOG_FILENAME = '/home/developer/sandbox/pdffiller.log' # Filename of log-file if log is written into file.
...
PID_FILE_PATH = '/tmp/daemon.pid' # full filename of daemon pid file
